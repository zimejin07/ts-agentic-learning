...
/**
 * Runs a tool by name. This function NEVER throws for tool/domain failures:
 * unknown tool, bad arguments, preflight, declined HITL, and crashes inside
 * the tool all become error strings the model can observe.
 *
